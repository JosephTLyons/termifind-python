...
class Settings:
    ...
    SHOULD_GROUP_ITEMS_BY_TYPE: bool = USER_SETTINGS_DICTIONARY.get("SHOULD_GROUP_ITEMS_BY_TYPE", True)

    SELECTOR_SYMBOL: str = USER_SETTINGS_DICTIONARY.get("SELECTOR_SYMBOL", "*")
    SELECTOR_SYMBOL_STYLE: str = USER_SETTINGS_DICTIONARY.get("SELECTOR_SYMBOL_STYLE", "bright_red")

    FILE_ITEM_EXCLUSION_LIST: list[str] = USER_SETTINGS_DICTIONARY.get("FILE_ITEM_EXCLUSION_LIST", [])
